...
HTTPS_GIT := github.com/rollchains/threeone.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=threeone \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c threeone --local -f chains.yaml
endif
